...
---
:::caution
자세히 확인해보지는 못했지만, Unity 6에서는 작동을 하지 않습니다.  
...
유니티 사용할 때의 팬 돌아가는 소리가 작아지긴 했다. 확실히 팬이 덜 돈다. 빠릿빠릿해지니 매우 좋은 현상이다.

그렇지만 여기까지 오니까 그냥 비주얼 스튜디오가 편하게 느껴진다. 배우면서까지 사용해야 할 필요를 별로 느끼지를 못하겠다. 

유니티와 사용하려면 결국 데몬을 써야한다. 위에서 언급했듯이 꽤 거슬린다. 실수로 cmd 창을 닫아버리면 그대로 꺼진다.    

...
에디터가 가벼운 것은 매우 좋다.  
내 노트북에서의 실행 기준으로 메모리 사용량은 아래와 같다.
- Visual Studio (1.7 ~ 2.8GB)
- Visual Studio Code (600 ~ 900MB)
- **Emacs (300MB)**

유니티 사용할 때의 팬 돌아가는 소리가 작아지긴 했다. 확실히 팬이 덜 돈다.
...
![DoomDashBoard](https://github.com/user-attachments/assets/7e92bc71-d5c5-4408-9b35-c3312b4c76ac)
